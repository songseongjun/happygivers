            ...
            <div class="px-0" style="max-width: 860px; width:100%;">
              <div>
				...
				<li class="list-group-item ">
					...
					<span class="col-1 text-center fw-bold">제목</span>
				...
				<li class="list-group-item">
					<div class="row my-0 align-items-center">
						...
						<span class="col-1 text-center text-truncate">${b.title }</span>
				...
				<div class="mt-4">
				<button class="btn btn-outline-secondary">선택 삭제</button>
				</div>
