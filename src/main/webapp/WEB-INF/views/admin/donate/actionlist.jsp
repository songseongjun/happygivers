	...
	<main class="d-flex justify-content-between mx-0">
            <div class="px-0" style="max-width: 860px; width:100%;">
              <div>
				...
				<li class="list-group-item">
					<div class="row my-0 align-items-center">
						<span class="col-2 text-center">${b.bno }</span>
						...
						<div class="btn-group btn-group-sm col-1">
							...
							<a href="${cp }/admin/board/orgboardstatuschange?bno=${b.bno}&status=DISABLED&name=${b.name}" class="btn btn-outline-secondary">환불</a>
							</c:if>
						</div>
					</div>
				</li>
